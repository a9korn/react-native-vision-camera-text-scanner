...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<margelo::nitro::camera::textrecognizer::BoundingBox> final {
    static inline margelo::nitro::camera::textrecognizer::BoundingBox fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::camera::textrecognizer::BoundingBox(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::camera::textrecognizer::BoundingBox& arg) {
